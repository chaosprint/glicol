...
// "sin" is a node that outputs sine wave signal based on its argument frequency
// in this example, "sin" has no input signal
// "mul" has one input from its left hand side
// "mul" processes the input signal
// by multiplying the input signal with its first argument
...
// which is called lazy evaluation
...
// you can fold a line like this
// but always have a blank line or a comment between two chains`

const usesample = 
`// To use samples, first click the settings button on top
...
const demo1 = `// Click the settings to select ***useSamples*** first!

bd: speed 1.375 >> seq 60 >> sampler \\breaks165
...
const demo2 = `// Click the settings to select ***useSamples*** first!

bd: speed 4.0 >> seq 60 >> sampler \\909
...
const intro = `// Welcome!
// GLICOL (an acronym for "graph-oriented live coding language")
// is a computer music language written in Rust.

// Run the code to make music by clicking the play button on the top.
// You can make some changes to the code parameters and update the music.

// It is currently tested on Chrome, Firefox and Edge;
// Please open the ***Console*** in the browser to see more details:

//                Chrome/Edge               Firefox
// Windows  |   Ctrl + Shift + J    |    Ctrl + Shift + I
// Mac OS   | command + option + j  |  command + option + i\n\n`+welcome

export {hello, am, fm, envelope, usesample, filter, demo1, demo2, welcome, intro}

// export default [demo1, demo2, filter]
