...
*/
export function process(size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.process(retptr, size);
...
* @param {number} sr
*/
export function add_sample(name, sample, channels, sr) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF32ToWasm0(sample, wasm.__wbindgen_export_0);
...
export function send_msg(msg) {
    ...
    const len0 = WASM_VECTOR_LEN;
    wasm.send_msg(ptr0, len0);
}

/**
* @param {boolean} io
*/
export function live_coding_mode(io) {
    wasm.live_coding_mode(io);
}

/**
* @param {number} bpm
*/
export function set_bpm(bpm) {
    wasm.set_bpm(bpm);
}
...
* @param {number} amp
*/
export function set_track_amp(amp) {
    wasm.set_track_amp(amp);
}

/**
* @param {number} sr
*/
export function set_sr(sr) {
    wasm.set_sr(sr);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('glicol_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
