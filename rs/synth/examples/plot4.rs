...
fn main () {
    ...
    let node_a = context.add_multi_chan_node( 1, Impulse::new().freq(10.0));
    let node_b = context.add_multi_chan_node( 2, Sampler::new((&[1.0, 0.0, 0.0, 0.0], 2)));
    let node_c = context.add_multi_chan_node( 2, Mul::new(0.5) );
    // let node_b = context.add_mono_node(DelayMs::new().delay(10.0));
