                                    ...
                                    Rule::msgsynth => {
                                        ...
                                        if p2.is_some() {
                                            paras.push(GlicolPara::Number(
                                                p2.unwrap().as_str().parse::<f32>().unwrap(),
                                            ));
                                        }
                                        let p3 = iter.next();
                                        if p3.is_some() {
                                            paras.push(GlicolPara::Number(
                                                p3.unwrap().as_str().parse::<f32>().unwrap(),
                                            ));
                                        }
                                        chain_paras.push(paras)
                                    }
